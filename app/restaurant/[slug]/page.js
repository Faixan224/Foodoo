    ...
    <>
      <style>{`
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .hero { position: relative; height: 220px; background: #1A1A1A; overflow: hidden; }
        .hero-ph { width: 100%; height: 100%; display: flex; align-items: center; justify-content: center; }
        .hero-gradient { position: absolute; inset: 0; background: linear-gradient(to bottom, transparent 40%, rgba(0,0,0,0.7) 100%); }
        ...
        .divider { height: 8px; background: #F7F7F7; margin: 0 -20px 20px; }
        ...
        .dish-img-wrap { position: relative; height: 130px; background: #1A1A1A; overflow: hidden; }
        ...
        .top-badge { position: absolute; top: 8px; left: 8px; background: #F86D1C; color: #fff; font-size: 10px; font-weight: 700; padding: 3px 8px; border-radius: 6px; }
        .dish-info { padding: 10px 12px 12px; }
        .dish-name { font-size: 13px; font-weight: 700; color: #1A1A1A; line-height: 1.3; }
        .dish-cat { font-size: 11px; color: #999; margin-top: 2px; }
              ...
              {dishes.map((dish, i) => (
                <a key={dish.id} href={'/dish/' + dish.id} className="dish-card">
                  <div className="dish-img-wrap">
                    ...
                    {dish.weighted_score > 0 && i === 0 && (
                      <div className="top-badge">⭐ Top Dish</div>
                    )}
                  </div>
